function [m1,m2,m3,m4,m5,m6,m7,m8,m9,m10] = stack2param(stack, decodeInfo)
...
m9 = reshape(stack(num+1:num+prod(decodeInfo(9,:))),decodeInfo(9,1),decodeInfo(9,2));
num = num+prod(decodeInfo(9,:));

m10 = reshape(stack(num+1:num+prod(decodeInfo(10,:))),decodeInfo(10,1),decodeInfo(10,2));
num = num+prod(decodeInfo(10,:));