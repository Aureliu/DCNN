...
%% test:1821, valid:872  Sentiment Prediction, binary mode.
%% test is 1821*58, I think that the length of row is the max size of sentence. If not a word,
%% it is padded by 15448, the element in test is the index in cdll index.
